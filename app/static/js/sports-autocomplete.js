const LEAGUE_TEAMS = {
  mlb: [
    ...
    {abbr:"BOS",name:"Red Sox"},{abbr:"CHC",name:"Cubs"},{abbr:"CWS",name:"White Sox"},
    ...
    {abbr:"NYY",name:"Yankees"},{abbr:"OAK",name:"Athletics"},{abbr:"PHI",name:"Phillies"},
  ...
  nhl: [
    ...
    {abbr:"LAK",name:"Kings"},{abbr:"MIN",name:"Wild"},{abbr:"MTL",name:"Canadiens"},
    {abbr:"NSH",name:"Predators"},{abbr:"NJD",name:"Devils"},{abbr:"NYI",name:"Islanders"},
    {abbr:"NYR",name:"Rangers"},{abbr:"OTT",name:"Senators"},{abbr:"PHI",name:"Flyers"},
    {abbr:"PIT",name:"Penguins"},{abbr:"SJS",name:"Sharks"},{abbr:"SEA",name:"Kraken"},
    {abbr:"STL",name:"Blues"},{abbr:"TBL",name:"Lightning"},{abbr:"TOR",name:"Maple Leafs"},
    {abbr:"UTA",name:"Utah Hockey Club"},{abbr:"VAN",name:"Canucks"},{abbr:"VGK",name:"Golden Knights"},
    {abbr:"WSH",name:"Capitals"},{abbr:"WPG",name:"Jets"},
  ],
  wnba: [
    {abbr:"ATL",name:"Dream"},{abbr:"CHI",name:"Sky"},{abbr:"CON",name:"Sun"},
    {abbr:"DAL",name:"Wings"},{abbr:"IND",name:"Fever"},{abbr:"LA",name:"Sparks"},
  ...
  mls: [
    ...
    {abbr:"DAL",name:"FC Dallas"},{abbr:"DC",name:"D.C. United"},{abbr:"HOU",name:"Dynamo"},
    {abbr:"LA",name:"Galaxy"},{abbr:"LAFC",name:"LAFC"},{abbr:"MIA",name:"Inter Miami"},
    {abbr:"MN",name:"Loons"},{abbr:"MTL",name:"CF Montréal"},{abbr:"NE",name:"Revolution"},
    {abbr:"NYC",name:"NYCFC"},{abbr:"NJ",name:"Red Bulls"},{abbr:"ORL",name:"Orlando City"},
    {abbr:"PHI",name:"Union"},{abbr:"POR",name:"Timbers"},{abbr:"RSL",name:"Real Salt Lake"},
  ...
  premier_league: [
    ...
    {abbr:"CRY",name:"Crystal Palace"},{abbr:"EVE",name:"Everton"},{abbr:"FUL",name:"Fulham"},
    {abbr:"IPS",name:"Ipswich"},{abbr:"LEI",name:"Leicester"},{abbr:"LIV",name:"Liverpool"},
    {abbr:"MCI",name:"Man City"},{abbr:"MUN",name:"Man Utd"},{abbr:"NEW",name:"Newcastle"},
    {abbr:"NFO",name:"Nottm Forest"},{abbr:"SOU",name:"Southampton"},{abbr:"TOT",name:"Spurs"},
    {abbr:"WHU",name:"West Ham"},{abbr:"WOL",name:"Wolves"},
  ],
};
